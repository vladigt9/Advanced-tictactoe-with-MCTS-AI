...
class Hor_MCTS:
    """
        This class defines the Horizontal MCTS algorithm. It implements strategy 
        specific rewards.
    ...
    def _simulate(self, state, move):
        ...
        if winner[0] > winner[1]:
            ...
            if self.player == 1:
                if move[1] != state.board_size-1 and state.board[move[0], move[1]+1] == 1:
                    return 1.5
                elif move[1] != 0 and state.board[move[0], move[1]-1] == 1:
                    return 1.5
                else:
                    return 1
            else:
            ...
            if move[1] != state.board_size-1 and state.board[move[0], move[1]+1] == self.player:
                return 0.5
            elif move[1] != 0 and state.board[move[0], move[1]-1] == self.player:
                return 0.5
            else:
                return 0
