...
class Dia_MCTS:
    """
        This class defines the Diagonal MCTS algorithm. It implements strategy 
        specific rewards.
    ...
    def _select(self, node):
        """
            In this method the select function of MCTS is performed.
    ...
    def _simulate(self, state, move):
        ...
        if winner[0] > winner[1]:
            ...
            if self.player == 1:
                # bottom right
                if move[0] != state.board_size-1 and move[1] != state.board_size-1 and state.board[move[0]+1, move[1]+1] == 1:
                    return 1.5
                # top right
                elif move[0] != 0 and move[1] != state.board_size-1 and state.board[move[0]-1, move[1]+1] == 1:
                    return 1.5
                # top left
                elif  move[0] != 0 and move[1] != 0 and state.board[move[0]-1, move[1]-1] == 1:
                    return 1.5
                # bottom left
                elif  move[0] != state.board_size-1 and move[1] != 0 and state.board[move[0]+1, move[1]-1] == 1:
                    return 1.5
                else:
                    return 1
            else:
            ...
            if move[0] != state.board_size-1 and move[1] != state.board_size-1 and state.board[move[0]+1, move[1]+1] == self.player:
                return 0.5
            elif move[0] != 0 and move[1] != state.board_size-1 and state.board[move[0]-1, move[1]+1] == self.player:
                return 0.5
            elif  move[0] != 0 and move[1] != 0 and state.board[move[0]-1, move[1]-1] == self.player:
                return 0.5
            elif  move[0] != state.board_size-1 and move[1] != 0 and state.board[move[0]+1, move[1]-1] == self.player:
                return 0.5
            else:
                return 0
